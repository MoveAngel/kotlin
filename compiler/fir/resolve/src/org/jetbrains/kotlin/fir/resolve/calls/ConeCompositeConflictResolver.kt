...
class ConeCompositeConflictResolver(
    ...
    override fun chooseMaximallySpecificCandidates(
        candidates: Set<Candidate>, discriminateGenerics: Boolean, discriminateSAMs: Boolean
    ): Set<Candidate> {
        ...
        while (currentCandidates.size > 1 && index < conflictResolvers.size) {
            ...
            currentCandidates = conflictResolver.chooseMaximallySpecificCandidates(candidates, discriminateGenerics, discriminateSAMs)
        }
